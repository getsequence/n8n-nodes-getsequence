...
function readTransferFilters(ctx: IExecuteFunctions, i: number): IDataObject {
	...
	addOptional(qs, 'from', ctx.getNodeParameter('from', i, ''));
	addOptional(qs, 'to', ctx.getNodeParameter('to', i, ''));
	return qs;
}
...
export async function executeOperation(
	...
	if (resource === 'activity') {
		...
		if (operation === 'listCardTransactions') {
			...
			addOptional(filters, 'from', ctx.getNodeParameter('from', i, ''));
			addOptional(filters, 'to', ctx.getNodeParameter('to', i, ''));
